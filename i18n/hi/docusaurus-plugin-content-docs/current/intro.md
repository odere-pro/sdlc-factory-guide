...
1. **[Rule file तैयार करें](/docs/rule-file)** — agent को वह project knowledge दें जो किसी नए teammate को चाहिए होती है।
2. **[Context engineer करें](/docs/context-engineering)** — agent क्या देखता है और कब, इसे नियंत्रित करें।
3. **[Verification बनाएँ](/docs/verification)** — AI के साथ contract के रूप में tests और evals।
4. **[काम चलाएँ](/docs/running-the-work)** — conductor बनाम orchestrator, और agents आपके दिन में कहाँ फिट होते हैं।
5. **[Review करें और ship करें](/docs/review-and-ship)** — वे विफलताएँ पकड़ें जो "सही लगती हैं।"
6. **[Cost नियंत्रित करें](/docs/controlling-cost)** — total cost of ownership और model routing।
7. **[Production agents ship करें](/docs/production-agents)** — prototype script से substrate वाले product तक।
8. **[Team standard बनाएँ](/docs/team-standard)** — harness को version करें, evals पर gate लगाएँ, judgment के लिए hire करें।
